#ifndef __LINA_LFILES_COLOR_H__
#define __LINA_LFILES_COLOR_H__
...
llibs_file_status_t llibs_OpenFile(llibs_file_t *llibs_file, lchar_t filiname[]){
    llibs_file->fileHandle = llibs_GetFileHandle(filiname);
